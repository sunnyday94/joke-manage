...
$(function(){
    ...
    $('.weblogothird').popover({
        content : '建议jpg,jpeg,png.尺寸120*45px',
        trigger : 'hover'
    });
    $('.bsetHotline').popover({
    ...
    $('.loginImg').popover({
        content : '显示在前台会员登陆页面背景，'+'建议jpg,jpeg,png.尺寸1920*420px',
        trigger : 'hover'
    });
    $('.regImg').popover({

        content : '显示在前台会员注册成功页面，'+'建议jpg,jpeg,png.尺寸1920*480px',
        trigger : 'hover'
    });
    $('.regImg_register').popover({
        content : '显示在前台会员注册页背景，'+'建议jpg,jpeg,png.尺寸1920*480px',
        trigger : 'hover'
    });
    $('.loginImg_third').popover({
        content : '显示在新商家登陆页背景，'+'建议jpg,jpeg,png.尺寸1920*420px',
        trigger : 'hover'
    });
    $('.regImg_third').popover({
        content : '显示在新商家注册页背景，'+'建议jpg,jpeg,png.尺寸1920*513px',
        trigger : 'hover'
    });
    ...
    $('.mobileLogoImg').popover({
        content : '显示在移动端搜索框左边，'+'建议jpg,jpeg,png.尺寸32*32px',
        trigger : 'hover'
    });
});
