                ...
                if (cateGrade == '3') {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $("#cate_list1").find(".cate_item").removeAttr("onclick");
                        }
                    });
                } else {
                    //自动点击第一个分类
        ...
        success: function (data) {
            ...
            if ($("#cate_list2").find("div.cate_item").length > 0) {
                ...
                if (cateGrade == '3' && $("#cate_item" + $("#cateParentId").val()).length > 0) {
                    ...
                    $("#cate_list2").find(".cate_item").removeAttr("onclick");
                } else {
                    //自动点击第一个分类，
        ...
        success: function (data) {
            ...
            if ($("#cate_list3").find("div.cate_item").length > 0) {
                ...
                if (cateGrade == '3' && $("#cate_item" + $("#cateId").val()).length > 0) {
                    ...
                    $("#cate_list3").find(".cate_item").removeAttr("onclick");
                } else {
...
function call_update_goods() {
    /*$(".goods_desc").val(editor2.html());*/
    /*$(".goods_mobile_desc").val(editor3.html());*/
    if($(".ogoodsSeoTitle").val() != undefined && $(".ogoodsSeoTitle").val() != 'undefined'){
    	$(".goodsSeoTitle").val($(".ogoodsSeoTitle").val());
    }
    if($(".ogoodsSeoKeyword").val() != undefined && $(".ogoodsSeoKeyword").val() != 'undefined'){
    	$(".goodsSeoKeyword").val($(".ogoodsSeoKeyword").val());
    }
    if($(".goodsSeoDesc").val() != undefined && $(".goodsSeoDesc").val() != 'undefined'){
    	$(".goodsSeoDesc").val($(".ogoodsSeoDesc").val());
    }

    var aboutGoodsIds = $(".oaboutGoodsId");
    for (var i = 0; i < aboutGoodsIds.length; i++) {
        var  myid = aboutGoodsIds[i];
        $("#goodsBaseForm").append("<input type='hidden' name='aboutGoodsId' value='" + myid.value + "' >");
    }
    ...
    $("input[name=aboutGoodsIdSelect]:checkbox").each(function () {
        if ($(this).is(':checked') == true) {
            ...
            if ($("#selectedGoods" + $(this).val()) == undefined || $("#selectedGoods" + $(this).val()).length <= 0) {
                ...
                '   <td><input type="hidden" class="oaboutGoodsId" name="aboutGoodsId" value="' + $(this).val() + '"/><input type="hidden" id="selectedGoods' + $(this).val() + '" value="' + $(this).val() + '"/>' +
