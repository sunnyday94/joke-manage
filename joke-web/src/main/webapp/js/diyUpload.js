	...
	function createBox( $fileInput, file, webUploader ) {
		...
		if ( $parentFileBox.find('.diyButton').length <= 0 ) {
			...
			var div = '<div class="diyButton"> \
						<a class="diyStart btn btn-primary" href="javascript:void(0)">开始上传</a> \
						<a class="diyCancelAll btn btn-default" href="javascript:void(0)">全部取消</a> \
					</div>';
		...
		var li = '<li id="fileBox_'+file_id+'" class="diyUploadHover"> \
					...
					<div class="diyCancel"><i class="glyphicon glyphicon-trash"></i></div> \
